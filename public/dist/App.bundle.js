...
(0, _bling.$)('.addBtn').on('click', function () {
  ...
  (0, _mutationTodo.addTodo)((0, _bling.$)("#myInput").value).then(function (_ref2) {
    var data = _ref2.data;
