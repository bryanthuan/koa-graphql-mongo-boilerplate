...
var _mutationTodo = __webpack_require__(4);
...
function renderTodo(_ref) {
  ...
  var fromNow = updatedAt ? (0, _moment2.default)(updatedAt).startOf('hour').fromNow() : (0, _moment2.default)(createdAt).startOf('hour').fromNow();
...
var _renderTodo = __webpack_require__(128);
...
var _queryTodos = __webpack_require__(127);

var _queryTodos2 = _interopRequireDefault(_queryTodos);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _queryTodos2.default)().then(function (_ref) {
  var data = _ref.data;
...
(0, _bling.$)('.addBtn').on('click', function () {
  if ((0, _bling.$)("#myInput").value === '') {
    alert('You must write something');
    return;
  }
  (0, _mutationTodo.addTodo)((0, _bling.$)("#myInput").value).then(function (_ref3) {
    var data = _ref3.data;
...
(0, _bling.$)("#myInput").on('keydown', function (e) {
  ...
  (0, _mutationTodo.addTodo)(e.target.value).then(function (_ref4) {
    var data = _ref4.data;
